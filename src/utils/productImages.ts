...
import artichaut from '@/assets/products/artichaut-new.jpg';
import artichautBeldi from '@/assets/products/artichaut-beldi-new.jpg';
...
export const productImagesByName: Record<string, string> = {
  ...
  'artichauts-beldi': artichautBeldi,
  'artichaud': artichaut,
  'artichaud-beldi': artichautBeldi,
  'basilic': basilic,
  'cardon': cardon,
